...
SELECT [sr].[ScrubRunID], [sd].[DatabaseName], [st].[TableSchema], [st].[TableName],[st].[PrimaryKey01],[ube].[EntityPK01Value], [st].[PrimaryKey02], [ube].[EntityPK02Value],
