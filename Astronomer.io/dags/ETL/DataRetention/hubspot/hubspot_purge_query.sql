...
SELECT  [sr].[ScrubRunID], [sd].[DatabaseName], [st].[TableSchema], ' ' as TableName,[st].[PrimaryKey01],[ube].[EntityPK01Value],
...
AND [sd].[DatabaseName] = 'Hubspot' AND [st].[TableSchema] = 'Hubspot'