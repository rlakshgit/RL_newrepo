...
from plugins.operators.jm_ratabase_to_gcp import RatabaseToGoogleCloudStorageOperator
...
with DAG(
    ...
    for ratabase_type in ['CL', 'PA']:
        ...
        for ref_table in refined_table_list:
            ...
            [file_list >> land_data >> create_dataset >> refine_data >> audit_data >> bit_set]
