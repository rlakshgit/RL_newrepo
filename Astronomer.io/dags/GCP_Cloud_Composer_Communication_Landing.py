...
from plugins.operators.jm_mongodb_to_gcs_communication import Mongodbtogcs
...
collection='communicationdocuments'
database_name='platform-communication-v2'
...
with DAG(
        'zing_communication_landing_dag',
    ...
    entity_list = ['emailmessage','emailmessage_MessageRetryAttempts','emailmessage_To',
                   'emailmessage_Cc','emailmessage_Bcc','usernotification',
                   'smsmessage','smsmessage_MessageRetryAttempts','smsmessage_To',
                   'notification','notification_MessageRetryAttempts','notification_Segments','notification_Segments_LocationIds',
                   'notification_Segments_PersonIds',
                   'smsreplymessage']
    
    try:
        HISTORY_CHECK = Variable.get('communication_history_check')
    except:
        Variable.set('communication_history_check', 'True')
        HISTORY_CHECK = Variable.get('communication_history_check')
    ...
    set_full_load_var = PythonOperator( task_id = 'set_history_load_var',
                                                ...
                                                op_kwargs = {"k" : "communication_history_load", "v": "N"} )
