...
from plugins.operators.jm_mongodb_to_gcs_identity import Mongodbtogcs
...
# collections= ['apiresource','client','custompersistedgrant','identitydocuments','identityresource','migrations','users']
collections= ['users']
database_name='platform-identity'
