...
from plugins.operators.jm_identity_staging import MembershipStagingOperator
...
confFilePath = os.path.join(configuration.get('core', 'dags_folder'), r'zing_identity', r'ini', r"identity_config.ini")
...
with DAG(
    ...
    for table in membership_tables:
        if '_' in table:
            ...
            external_dag_id='zing_identity_landing_dag',
