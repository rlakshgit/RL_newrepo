...
from plugins.operators.jm_mongodb_to_gcs_posint import Mongodbtogcs
...
source_abbr = 'posint'
collections= ['posintegrationdocuments']
database_name='platform-posintegration'
...
with DAG(
        'zing_posintegration_landing_dag',
    ...
    #entity_list = ['users','users_loginHistory','users_claims']
    entity_list = ['posintegrationdocuments','posintegrationdocuments_Order_Items']
    #entity_list = ['posintegrationdocuments'] 
