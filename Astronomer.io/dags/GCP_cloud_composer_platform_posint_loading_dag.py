...
from plugins.operators.jm_posint_staging import MembershipStagingOperator
...
confFilePath = os.path.join(configuration.get('core', 'dags_folder'), r'ini', r"posintegration_config.ini")
...
with DAG(
        'zing_posintegration_loading_dag',
        schedule_interval= '0 10 * * *', #"@daily",#dt.timedelta(days=1), #
        catchup=True,
        max_active_runs=1,
    ...
    for table in membership_tables:
        if '_' in table:
            ...
            external_dag_id='zing_posintegration_landing_dag',
