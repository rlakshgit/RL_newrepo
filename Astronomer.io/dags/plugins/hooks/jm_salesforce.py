...
class SalesforceHook(BaseHook):
    ...
    def get_conn(self):
        ...
        # print(self.extras['organizationId'],
        #     self.extras['domain'])
        # print(self.connection.login,
        ...
        sf = Salesforce(
            ...
            organizationId=self.extras['organizationId'],
            domain=self.extras['domain'])
        self.sf = sf
    ...
    def describe_all(self):
        """
        Get the description of  Salesforce.
        """
        conn = self.get_conn()
