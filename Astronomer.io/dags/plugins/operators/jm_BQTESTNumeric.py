...
class BQTESTNumeric(BaseOperator):
    """
    ...
    def __init__(self,
        ...
        super(BQTESTNumeric, self).__init__(*args, **kwargs)
    ...
    def execute(self, context):
        ...
        df['CNV_AMT'] = df['CNV_AMT'].astype(float)
        bq_pdq_hook=JMBQHook(bigquery_conn_id =self.bigquery_conn_id,
        ...
        bq_pdq_hook.write_data(df,self.schema_fields)
