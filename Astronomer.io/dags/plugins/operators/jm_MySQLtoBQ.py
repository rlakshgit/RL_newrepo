...
class MySqlToBQOperator(BaseOperator):
    """Copy data from MySQL to BQ
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(MySqlToBQOperator, self).__init__(*args, **kwargs)
