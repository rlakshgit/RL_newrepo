...
class SalesforceAuditOperator(BaseOperator):
    """
    ...
    template_fields = ("audit_filename","metadata_filename")
    ...
    def __init__(self,
        ...
        super(SalesforceAuditOperator, self).__init__(*args, **kwargs)
