...
class SQLServertoBQAppendingOperator(BaseOperator):
    """
    ...
    def __init__(self,
        ...
        super(SQLServertoBQAppendingOperator, self).__init__(*args, **kwargs)
        self.sql = sql
    ...
    def execute(self, context):
        print('context ds_nodash:', context['ds_nodash'])
        print('context ds:', context['ds'])
        print('type of ds:', type(context['ds_nodash']))
        print('- '*100)
        print(context['prev_execution_date'])
        print('- '*100)
        print(self.sql)
