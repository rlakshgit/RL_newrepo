...
class EASStagingOperator(BaseOperator):
    ...
    def __init__(self,
                 ...
                 *args,
                 **kwargs):
        super(EASStagingOperator, self).__init__(*args, **kwargs)
    ...
    def execute(self, context):
        ...
        logging.info(" list of files ", len(file_list), " type of files ", type(file_list))
        eas_files_availability='eas_files_availability_{table}'.format(table=self.table)
