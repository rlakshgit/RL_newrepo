...
class GCSHook(GoogleBaseHook):
    ...
    def __init__(self,
                 ...
                 delegate_to=None):
        super(GCSHook, self).__init__(google_cloud_storage_conn_id,
                                                     delegate_to)
    ...
    def get_conn(self):
        ...
        """
        if not self._conn:
            self._conn = storage.Client(credentials=self.get_credentials(),
    ...
    # pylint:disable=redefined-builtin
    def upload(self, bucket, object,data='NA',filename=None,
