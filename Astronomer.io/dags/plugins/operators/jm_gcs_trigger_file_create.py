...
class GoogleCloudStorageTriggerFileCreateOperator(BaseOperator):
    """
    ...
    def __init__(self,
        ...
        super(GoogleCloudStorageTriggerFileCreateOperator, self).__init__(*args, **kwargs)
    ...
    def execute(self, context):
        ...
        self.log.info("Creating trigger file %s objects from %s",
                      len(objects), self.bucket_name)

        for object_name in objects:
            hook.upload(self.bucket_name, object=object_name,data='trigger_file',filename=None)
        # for object_name in objects:
        #     try:
        #         hook.delete(bucket=self.bucket_name,
        #                 object=object_name)
        #     except:
        #         self.log.info('Blob %s not found.', object_name)