...
from plugins.operators.jm_sql_to_gcs_semimanaged import JM_BaseSQLToGoogleCloudStorageOperator
from plugins.hooks.jm_mssql import MsSqlHook
from airflow.utils.decorators import apply_defaults


class JM_MsSqlToGoogleCloudStorageOperator(JM_BaseSQLToGoogleCloudStorageOperator):
