...
class JM_BaseSQLToGoogleCloudStorageOperator(BaseOperator, metaclass=abc.ABCMeta):
    """
    ...
    def __init__(self,  # pylint: disable=too-many-arguments
                 ...
                 *args,
                 **kwargs):
        super(JM_BaseSQLToGoogleCloudStorageOperator, self).__init__(*args, **kwargs)
    ...
    def _write_local_data_files(self, cursor):
        ...
        for row in cursor:
            ...
            if self.export_format == 'csv':
                ...
                tmp_file_handle.write(json.dumps(row_dict, default=myconverter, sort_keys=True).encode('utf-8'))
