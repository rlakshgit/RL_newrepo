...
SELECT DISTINCT
	...
	,CASE	WHEN t.RecastBefore2014 = 'Express' THEN 'Express' --renamed JP - online to Express on 1/20/2022
			ELSE t.RecastBefore2014 
	 END AS Recast
	,CASE	WHEN t.RecastBefore2014 = 'Jeweler Programs' THEN 'JC Paper & CAP' -- Renamed JP - In Store to Jeweler Programs  on 1/20/2022
...
FROM
	(
		SELECT DISTINCT
			...
			,CASE	WHEN dPol.SourceOfBusiness IN ('Jewelers Cut','LINK') THEN 'Jeweler Programs' -- Renamed JP - In Store to Jeweler Programs 1/19/2022
